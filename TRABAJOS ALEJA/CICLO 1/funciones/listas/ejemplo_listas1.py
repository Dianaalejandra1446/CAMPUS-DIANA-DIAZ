...
#BUSCAR UN ELEMENTO SI ESTA DEVUELCE LA POSICION Y SINO DEVUELVE -1
print("=" * 30)
pos = buscarElem(miLista, "Carlos")
print(pos)

#BUSCAR UN ELEMENTO EN LA LISTA SI ESTA,DEVUELVE TRUE,SI NO FALSE
print("=" * 30)
esta = encontrarElem(miLista, "Cristian")
print(esta)
